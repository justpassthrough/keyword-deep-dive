...
# ══════════════════════════════════════════════════════════
STORY_SEEDS = [
    # 다이어트·체중 (지금 GLP-1 트렌드로 제일 뜨거움)
    "연예인 다이어트", "다이어트 고백", "감량 고백", "체중 감량", "몸매 변화",
    "다이어트 근황", "위고비", "마운자로", "삭센다", "다이어트 성공", "다이어트 비결",
    # 피부·미용·안티에이징
    "연예인 피부관리", "동안 비결", "피부 비결", "글루타치온 주사",
    # 장·소화
    "연예인 장건강", "장 건강 고백",
    # 탈모·모발
    "탈모 고백", "연예인 탈모",
    ...
    "갱년기 고백", "갱년기 극복",
    # 영양제·건강 전반·면역
    "연예인 영양제", "건강 관리 비결", "건강 고백", "연예인 건강",
    # 수면·정신건강
    "수면 습관", "불면증 고백",
]
# 뉴스 제목에서 인물과 짝지을 건강 키워드
#   성분·약물(INGREDIENT)은 이미 포함 → 유산균·콜라겐·루테인·미녹시딜 등 자동 커버.
#   여기에 성분에 안 묶이는 '건강 토픽어'(탈모·갱년기 등)를 더해 비-다이어트 조합도 잡음.
HEALTH_PAIR = INGREDIENT | {"다이어트", "감량", "탈모", "갱년기", "불면증", "디톡스"}
